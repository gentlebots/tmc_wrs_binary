...
screen -dm bash -c "source /eloquent_moveit_ws/install/setup.bash; export ROS_IP=172.20.0.5; export ROS_MASTER_URI=http://172.20.0.3:11311; ros2 launch ros1_bridge dedicated_bridges_launch.py"
...
export ROS_IP=172.20.0.5;
export ROS_MASTER_URI=http://172.20.0.3:11311;
